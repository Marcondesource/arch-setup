...
BASE="git curl nano wget ark unzip zip unrar redshift openssh ufw gparted dosfstools python python-pip android-tools usbutils gvfs gvfs-mtp ufw xdg-user-dirs fastfetch flatpak bluez bluez-utils bluez-tools blueman"
LOGIN="lxdm"
UTILITARIOS="firefox alacritty kate mpv dialog flatpak rsync"
...
OPENBOX="openbox tint2 plank obconf-qt rofi flameshot dunst lxappearance sxhkd picom network-manager-applet "
YAY="nitrogen"
...
sudo pacman -S --noconfirm $BASE $OPENBOX $FONTS $LOGIN $ARQUIVOS $UTILITARIOS || true
sudo systemctl enable lxdm
xdg-user-dirs-update
check "Erro ao instalar OPENBOX"
